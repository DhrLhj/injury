...
export default function () {
    ...
    function renderResult(resultData) {
        ...
        if (jsonData.action === "started") {
            ...
            if (resultTextTemp.includes("进入个人中心")) {
                console.log("个人中心---")
                router.push('/information')
            } else if (resultTextTemp.includes('系统通知')) {
                console.log("系统通知----")
                router.push('/notice')
            ...
            } else if (resultTextTemp==='进入伤情识别') {
                console.log("伤情识别----")
                router.push("/homeTrain")
            } else if (resultTextTemp.includes('急救')) {
                console.log("急救指南----")
                router.push("/study/right/detail")
            } else if (resultTextTemp==='进入教学模式') {
                console.log("教学模式----")
                router.push("/Teaching")
            } else if (resultTextTemp==='返回首页') {
                console.log("首页----")
                router.push('/')
            ...
            }  else if (resultTextTemp.includes('进入') && (resultTextTemp.includes('11') || resultTextTemp.includes('十一')) && resultTextTemp.includes("节点")) {
                console.log("辨别烧伤----")
                // router.push("/study/right/1")
                document.querySelector('#leftItem1').click()
            } else if (resultTextTemp==="返回伤情识别") {
                router.push("/homeTrain")
            ...
            }  else if (resultTextTemp.includes('进入') && (resultTextTemp.includes('12') || resultTextTemp.includes('十二')) && resultTextTemp.includes("节点")) {
                console.log("辨别烧伤----")
                // router.push("/study/right/1")
                document.querySelector('#leftItem2').click()
            ...
            } else if (resultTextTemp.includes('进入') && (resultTextTemp.includes('13') || resultTextTemp.includes('十三')) && resultTextTemp.includes("节点")) {
                console.log("辨别烧伤----")
                // router.push("/study/right/1")
                document.querySelector('#leftItem13').click()
            ...
            } else if (resultTextTemp.includes('进入') && resultTextTemp.includes('21') && resultTextTemp.includes("节点")) {
                console.log("辨别烧伤----")
                // router.push("/study/right/1")
                document.querySelector('#leftItem3').click()
            ...
            } else if (resultTextTemp.includes('进入') && resultTextTemp.includes('22') && resultTextTemp.includes("节点")) {
                console.log("辨别烧伤----")
                // router.push("/study/right/1")
                document.querySelector('#leftItem4').click()
            ...
            } else if (resultTextTemp.includes('进入') && resultTextTemp.includes('23') && resultTextTemp.includes("节点")) {
                console.log("辨别烧伤----")
                // router.push("/study/right/1")
                document.querySelector('#leftItem14').click()
            ...
            } else if (resultTextTemp.includes('进入') && resultTextTemp.includes('31') && resultTextTemp.includes("节点")) {
                console.log("辨别烧伤----")
                // router.push("/study/right/1")
                document.querySelector('#leftItem5').click()
            ...
            } else if (resultTextTemp.includes('进入') && resultTextTemp.includes('32') && resultTextTemp.includes("节点")) {
                console.log("辨别烧伤----")
                // router.push("/study/right/1")
                document.querySelector('#leftItem6').click()
            ...
            } else if (resultTextTemp.includes('进入') && resultTextTemp.includes('33') && resultTextTemp.includes("节点")) {
                console.log("辨别烧伤----")
                // router.push("/study/right/1")
                document.querySelector('#leftItem15').click()
            ...
            } else if (resultTextTemp.includes('进入') && resultTextTemp.includes('42') && resultTextTemp.includes("节点")) {
                console.log("辨别烧伤----")
                // router.push("/study/right/1")
                document.querySelector('#leftItem8').click()
            ...
            } else if (resultTextTemp.includes('进入') && resultTextTemp.includes('43') && resultTextTemp.includes("节点")) {
                console.log("辨别烧伤----")
                // router.push("/study/right/1")
                document.querySelector('#leftItem16').click()
            ...
            } else if (resultTextTemp.includes('进入') && resultTextTemp.includes('51') && resultTextTemp.includes("节点")) {
                console.log("辨别烧伤----")
                // router.push("/study/right/1")
                document.querySelector('#leftItem9').click()
            ...
            } else if (resultTextTemp.includes('进入') && resultTextTemp.includes('52') && resultTextTemp.includes("节点")) {
                console.log("辨别烧伤----")
                // router.push("/study/right/1")
                document.querySelector('#leftItem10').click()
            ...
            } else if (resultTextTemp.includes('进入') && resultTextTemp.includes('53') && resultTextTemp.includes("节点")) {
                console.log("辨别烧伤----")
                // router.push("/study/right/1")
                document.querySelector('#leftItem17').click()
            ...
            } else if (resultTextTemp.includes('进入') && resultTextTemp.includes('61') && resultTextTemp.includes("节点")) {
                console.log("辨别烧伤----")
                // router.push("/study/right/1")
                document.querySelector('#leftItem11').click()
            ...
            } else if (resultTextTemp.includes('进入') && resultTextTemp.includes('62') && resultTextTemp.includes("节点")) {
                console.log("辨别烧伤----")
                // router.push("/study/right/1")
                document.querySelector('#leftItem12').click()
            ...
            } else if (resultTextTemp.includes('进入') && resultTextTemp.includes('63') && resultTextTemp.includes("节点")) {
                console.log("辨别烧伤----")
                // router.push("/study/right/1")
                document.querySelector('#leftItem18').click()
