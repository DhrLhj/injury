<template>
    ...
    <div style="display: inline-block;float: right;border-left: 2px solid #dcdfe6;width: 92%;height: 100%;">
        <div id="rightSel" style="margin-left: 10%;margin-top: 1%;">
            ...
            <div>
            <el-image class="imgTwo" :src="require('@/assets/imagebox/bruise/1.jpg')" alt="" style="height: 60vh;width: 90%;" />
            </div>
            ...
            <el-button id="myButton" @click="playVedio()" type="primary">点击查看操作视频</el-button>
            ...
            <div style="width: 90%;">
                <el-row style="">
                    <el-col style="margin-right: 2%;margin-top: 2%;" v-for="(img,index) in imagebox" :key="index" :span="8" :index="index" @click="selecte(index)">
                        <el-card>
                            <el-image class="imgOne" :src="img" alt="" style="display: flex;height: 25vh;" />
                        </el-card>
                    </el-col>
                </el-row>
            </div>
            ...
            <div :class='{isShowVedio:showvedio==true}'>
                ...
                <div id="videosel" style="display: flex;margin-top: 1%;font-size: 1.8vh;align-items: center;">
                <el-divider style="margin: 0;border-width: 3px;border-color: black;" direction="vertical" />
                <span style="margin-left: 0.5%;">请选择正确的救治方案</span>
                </div>
                <video class="myVideo" ref="videoPlayer" controls style="width: 90%;height: 88%;">
...
export default {
    ...
    data(){
        return {
            ...
            require('@/assets/imagebox/fracture/2.jpg'),
    ...
    methods:{
        ...
        moveTodesc(){
            console.log("开始移动")
            const target = document.getElementById('videosel');
            if (target) {
                target.scrollIntoView({ behavior: 'smooth' });
            }
            console.log("准备播放")
